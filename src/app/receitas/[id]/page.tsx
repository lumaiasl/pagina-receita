  ...
  return (
    <main className="grow py-8">
      <div className="container mx-auto">
        <Link
          className="flex text-orange-400 hover:text-orange-700 mb-6"
          href="/receitas"
        >
          <ChevronLeft />
        ...
        <section className="rounded-lg overflow-hidden shadow-md mx-2">
          ...
          <div className="flex flex-col gap-6 p-6">
            <div>
              ...
              <p className="text-center md:text-start">{recipe.description}</p>
            </div>

            <div className="grid grid-cols-2 place-items-center md:flex gap-4">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2">
                  {recipe.ingredients.map((ingredient, index) => (
                    <li className="marker:text-orange-500" key={index}>
                      {ingredient}
                    </li>
                  ))}
                </ul>
